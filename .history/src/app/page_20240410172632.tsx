    ...
    <main>
      ...
      <section className="mt-[-500px]">
        ...
        <div className="flex flex-wrap items-center justify-center flex-col md:flex-row gap-8 -mt-72">
            ...
            <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1] dark:bg-black dark:borer:-white/[0.2] border-black-[0.1] w-full md:!w-[350px] h-auto rounded-xl p-6 border">
              ...
              >
                ...
                <ul className="my-4 flex flex-col gap-2">
                  ...
                  <li className="flex tems-center gap-2">
          ...
          <CardContainer className="inter-var">
            <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1] dark:bg-black dark:border-[#E2CB] dark:borer:-white/[0.2] border-black-[0.1] w-full md:!w-[350px] h-auto rounded-xl p-6 border">
              <CardItem
                translateZ='50'
                className="text-xl font-bold text-neitral-600 dark:text-white"
              >
